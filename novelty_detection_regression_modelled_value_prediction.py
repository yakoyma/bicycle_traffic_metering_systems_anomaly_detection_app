...
if __name__ == '__main__':
    ...
    TRAIN_INPUT_CSV = 'datasets/novelty detection/train_dataset.csv'
    TEST_INPUT_CSV = 'datasets/novelty detection/test_dataset.csv'
    ...
    dump(
        model,
        'models/novelty detection/regression/perpetualbooster/model.joblib'
    )
