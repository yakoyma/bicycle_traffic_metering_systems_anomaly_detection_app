...
def get_prediction(date: str, meter_id: str, meter_name: str,
    ...
    try:
        ...
        if (date and meter_id and meter_name and date != meter_id and
            ...
            encoder_path = 'models/novelty detection/encoder/encoder.joblib'
            ...
            reg_encoder_path = ('models/novelty detection/encoder/'
                                'reg_encoder.joblib')
            ...
            scaler_path = 'models/novelty detection/scaler/scaler.joblib'
            scaler = load(scaler_path)
            scaled_meter_reading = scaler.transform([[meter_reading]])[0][0]

            # Prediction of Modelled value feature for novelty detection
            reg_model_path = ('models/novelty detection/regression/'
                              'perpetualbooster/model.joblib')
            ...
            model_path = 'models/novelty detection/model/model.joblib'
