"""
===============================================================================
Anomaly Detection Project: Applications dedicated to Outlier Detection for
...
# Encoder persistence
dump(encoder, 'models/outlier detection/encoder/encoder.joblib')
...
# Encoder persistence
dump(reg_encoder, 'models/outlier detection/encoder/reg_encoder.joblib')
...
# Encoder persistence
dump(scaler, 'models/outlier detection/scaler/scaler.joblib')
...
X_train_reg.to_csv('datasets/outlier detection/train_dataset.csv', index=False)
X_test_reg.to_csv('datasets/outlier detection/test_dataset.csv', index=False)
...
# Calculate contamination (anomalies rate)
...
# Model persistence
dump(model, 'models/outlier detection/model/unsupervised/model.joblib')
...
print(f'\nXGBOD model best hyperparams: {xgbod_study.best_params}')

# Instantiate the model
xgbod_hyperparams = {
    'max_depth': xgbod_study.best_params['max_depth'],
    'learning_rate': xgbod_study.best_params['learning_rate'],
    'n_estimators': xgbod_study.best_params['n_estimators'],
    'n_jobs': -1,
...
# Model persistence
dump(model, 'models/outlier detection/model/supervised/model.joblib')
