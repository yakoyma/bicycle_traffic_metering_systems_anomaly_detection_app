"""
===============================================================================
Anomaly Detection Project: Application dedicated to Outlier Detection for
...
def get_prediction(date: str, meter_id: str, meter_name: str,
    ...
    """This function predicts if there are outliers in bicycle traffic
    metering data using a trained Machine Learning (ML) model.
    ...
    try:
        ...
        if (date and meter_id and meter_name and date != meter_id and
            ...
            # Encode the Meter ID and Meter name features for outlier detection
            encoder_path = 'models/outlier detection/encoder/encoder.joblib'
            ...
            reg_encoder_path = ('models/outlier detection/encoder/'
                                'reg_encoder.joblib')
            ...
            scaler_path = 'models/outlier detection/scaler/scaler.joblib'
            scaler = load(scaler_path)
            scaled_meter_reading = scaler.transform([[meter_reading]])[0][0]

            # Prediction of Modelled value feature for outlier detection
            reg_model_path = ('models/outlier detection/regression/hpsklearn/'
                              'model.joblib')
            ...
            model_path = ('models/outlier detection/model/supervised/'
                          'model.joblib')
...
app = gr.Interface(
    ...
    title='Outlier Detection Application for Bicycle Counting System in Nantes'
)
