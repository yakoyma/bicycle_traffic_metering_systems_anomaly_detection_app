...
def lof_model_optimisation(trial) -> float:
    ...
    for train_index, val_index in kfolds.split(X_train, y_train):
        ...
        scores.append(balanced_accuracy_score(
            y_true=y_val_cv, y_pred=y_pred_val))
...
lof_hyperparams = {
    ...
    'contamination': lof_study.best_params['contamination'],
    'n_jobs': -1,
    'novelty': True
}
...
knn_hyperparams = {
    ...
    'n_jobs': -1,
    'contamination': knn_study.best_params['contamination']
}
iforest_hyperparams = {
    'n_estimators': iforest_study.best_params['n_estimators'],
    'contamination': iforest_study.best_params['contamination'],
